...
EXOCHAIN is a constitutional trust fabric: 20 Rust workspace packages, 115942 lines of Rust under `crates/`, 2,874 listed tests, and a formal proof chain demonstrating its intended governance properties.
...
EXOCHAIN is that judiciary for AI systems. Its five constitutional properties, backed by formal proofs and 2,874 listed workspace tests, provide the structural guarantee that:
