...
EXOCHAIN is a constitutional trust fabric: 20 Rust workspace packages, 115986 lines of Rust under `crates/`, 2,874 listed tests, and a formal proof chain demonstrating its intended governance properties.
