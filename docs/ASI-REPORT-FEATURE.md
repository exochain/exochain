...
EXOCHAIN is a constitutional trust fabric: 20 Rust workspace packages, 115937 lines of Rust under `crates/`, 2,871 listed tests, and a formal proof chain demonstrating its intended governance properties.
