...
EXOCHAIN is a constitutional trust fabric: 20 Rust workspace packages, 116033 lines of Rust under `crates/`, 2,875 listed tests, and a formal proof chain demonstrating its intended governance properties.
