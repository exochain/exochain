...
EXOCHAIN is a constitutional trust fabric: 20 Rust workspace packages, 116097 lines of Rust under `crates/`, 2,876 listed tests, and a formal proof chain demonstrating its intended governance properties.
