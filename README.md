...
| Rust LOC | 198401 | `wc -l` |
| Workspace tests | 4,456 listed | `cargo test --workspace -- --list` |
...
- **4,456 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 23 crates, 198401 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 4,456 listed workspace tests
