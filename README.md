...
| Rust LOC | 181936 | `wc -l` |
| Workspace tests | 4,266 listed | `cargo test --workspace -- --list` |
...
- **4,266 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 22 crates, 181936 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 4,266 listed workspace tests
