...
| Rust LOC | 198350 | `wc -l` |
| Workspace tests | 4,457 listed | `cargo test --workspace -- --list` |
...
- **4,457 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 23 crates, 198350 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 4,457 listed workspace tests
