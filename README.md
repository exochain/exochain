...
| Rust LOC | 115895 | `wc -l` |
| Workspace tests | 2,873 listed | `cargo test --workspace -- --list` |
...
- **2,873 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 20 crates, 115895 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 2,873 listed workspace tests
