...
| Rust LOC | 173790 | `wc -l` |
| Workspace tests | 4,126 listed | `cargo test --workspace -- --list` |
...
- **4,126 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 22 crates, 173790 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 4,126 listed workspace tests
