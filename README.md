...
| Rust LOC | 366917 | `wc -l` |
| Workspace tests | 6,026 listed | `cargo test --workspace -- --list` |
...
- **6,026 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 31 crates, 366917 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 6,026 listed workspace tests
