...
| Rust LOC | 115986 | `wc -l` |
| Workspace tests | 2,874 listed | `cargo test --workspace -- --list` |
...
- **2,874 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 20 crates, 115986 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 2,874 listed workspace tests
