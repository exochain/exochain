...
| Rust LOC | 115754 | `wc -l` |
| Workspace tests | 2,862 listed | `cargo test --workspace -- --list` |
...
- **2,862 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 20 crates, 115754 tracked LOC under crates/)
