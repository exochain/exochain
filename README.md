...
| Rust LOC | 173775 | `wc -l` |
| Workspace tests | 4,127 listed | `cargo test --workspace -- --list` |
...
- **4,127 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 22 crates, 173775 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 4,127 listed workspace tests
