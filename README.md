...
| Rust LOC | 201536 | `wc -l` |
| Workspace tests | 4,524 listed | `cargo test --workspace -- --list` |
...
- **4,524 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 23 crates, 201536 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 4,524 listed workspace tests
