...
| Rust LOC | 188810 | `wc -l` |
| Workspace tests | 4,304 listed | `cargo test --workspace -- --list` |
...
- **4,304 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 22 crates, 188810 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 4,304 listed workspace tests
